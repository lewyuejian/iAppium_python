...
#pytest -v cm_test.py --tc-file D:\CodeBase\iAppium_python\iAppium_python\iAppium_python.json --tc-format json
...
class IAppium(unittest.TestCase):
    ...
    def setUp(self):
        ...
        desired_caps['app'] = f'{os.path.abspath(os.curdir)}\\test\\app\ContactManager.apk'
